...
type DividendApiRouter interface { 
	GetDividendsByEstateId(http.ResponseWriter, *http.Request)
}
...
type TradeApiRouter interface { 
	...
	GetTradeRequestById(http.ResponseWriter, *http.Request)
...
type TxApiRouter interface { 
	GetTxDividend(http.ResponseWriter, *http.Request)
	GetTxTradeRequest(http.ResponseWriter, *http.Request)
}
...
type DividendApiServicer interface { 
	GetDividendsByEstateId(string) (interface{}, error)
}
...
type TradeApiServicer interface { 
	...
	GetTradeRequestById(int64) (interface{}, error)
	GetTradeRequestsByUserId(string, TradeStatus, TradeRequestStatus) (interface{}, error)
...
type TxApiServicer interface { 
	GetTxDividend(string, int64) (interface{}, error)
	GetTxTradeRequest(int64, string) (interface{}, error)
}
