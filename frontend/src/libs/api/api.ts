 ...
 * @export
 */
export const DividendApiAxiosParamCreator = function (
    ...
    txDividendGet: async (
      ...
      if (estateId === null || estateId === undefined) {
        throw new RequiredError(
          "estateId",
          "Required parameter estateId was null or undefined when calling txDividendGet."
        );
      }
      ...
      if (perShare === null || perShare === undefined) {
        throw new RequiredError(
          "perShare",
          "Required parameter perShare was null or undefined when calling txDividendGet."
        );
      }
...
export const DividendApiFp = function (configuration?: Configuration) {
  return {
    ...
    async txDividendGet(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<CrossTx>
    > {
      const localVarAxiosArgs = await DividendApiAxiosParamCreator(
        configuration
      ).txDividendGet(estateId, perShare, options);
      return (
 ...
 * @export
 */
export const DividendApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  return {
    ...
    txDividendGet(
      ...
      perShare: number,
      options?: any
    ): AxiosPromise<CrossTx> {
      return DividendApiFp(configuration)
        .txDividendGet(estateId, perShare, options)
...
export class DividendApi extends BaseAPI {
  ...
  public txDividendGet(estateId: string, perShare: number, options?: any) {
    return DividendApiFp(this.configuration)
      .txDividendGet(estateId, perShare, options)
 ...
 * @export
 */
export const EstateApiAxiosParamCreator = function (
  configuration?: Configuration
) {
  return {
    /**
    ...
    getEstateById: async (
      ...
      if (estateId === null || estateId === undefined) {
        throw new RequiredError(
          "estateId",
          "Required parameter estateId was null or undefined when calling getEstateById."
        );
      }
      const localVarPath = `/estate/{estateId}`.replace(
        `{${"estateId"}}`,
        encodeURIComponent(String(estateId))
      );
      const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
      let baseOptions;
      if (configuration) {
  ...
  return {
    ...
    async getEstateById(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<GetEstateOutput>
    > {
      const localVarAxiosArgs = await EstateApiAxiosParamCreator(
        configuration
      ).getEstateById(estateId, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
    ...
    async getEstates(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Estate>>
    > {
      const localVarAxiosArgs = await EstateApiAxiosParamCreator(
        configuration
      ).getEstates(options);
 ...
 * @export
 */
export const EstateApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  return {
    ...
    getEstateById(
      ...
      return EstateApiFp(configuration)
        .getEstateById(estateId, options)
        .then(request => request(axios, basePath));
    },
    /**
...
export class EstateApi extends BaseAPI {
  ...
  public getEstateById(estateId: string, options?: any) {
    return EstateApiFp(this.configuration)
      .getEstateById(estateId, options)
      .then(request => request(this.axios, this.basePath));
  }
 ...
 * @export
 */
export const TradeApiAxiosParamCreator = function (
  configuration?: Configuration
) {
  return {
    /**
    ...
    deleteTrade: async (
      ...
      if (id === null || id === undefined) {
        throw new RequiredError(
          "id",
          "Required parameter id was null or undefined when calling deleteTrade."
        );
      }
      const localVarPath = `/trade/{id}`.replace(
        `{${"id"}}`,
    ...
    deleteTradeRequest: async (
      ...
      if (id === null || id === undefined) {
        throw new RequiredError(
          "id",
          "Required parameter id was null or undefined when calling deleteTradeRequest."
        );
      }
      const localVarPath = `/trade/request/{id}`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id))
      );
      const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
    ...
    postTrade: async (
      ...
      localVarRequestOptions.data = needsSerialization
        ? JSON.stringify(trade !== undefined ? trade : {})
        : trade || "";
    ...
    postTradeRequest: async (
      ...
      const needsSerialization =
        typeof postTradeRequestInput !== "string" ||
        localVarRequestOptions.headers["Content-Type"] === "application/json";
      localVarRequestOptions.data = needsSerialization
        ? JSON.stringify(
            postTradeRequestInput !== undefined ? postTradeRequestInput : {}
          )
    ...
    txTradeRequestGet: async (
      ...
      if (tradeId === null || tradeId === undefined) {
        throw new RequiredError(
          "tradeId",
          "Required parameter tradeId was null or undefined when calling txTradeRequestGet."
        );
      }
      ...
      if (from === null || from === undefined) {
        throw new RequiredError(
          "from",
          "Required parameter from was null or undefined when calling txTradeRequestGet."
        );
      }
...
export const TradeApiFp = function (configuration?: Configuration) {
  return {
    ...
    async deleteTrade(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Trade>
    > {
      const localVarAxiosArgs = await TradeApiAxiosParamCreator(
        configuration
     ...
     * @throws {RequiredError}
     */
    async deleteTradeRequest(
      id: number,
      options?: any
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<TradeRequest>
    > {
      const localVarAxiosArgs = await TradeApiAxiosParamCreator(
        configuration
      ).deleteTradeRequest(id, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
    ...
    > {
      const localVarAxiosArgs = await TradeApiAxiosParamCreator(
        configuration
      ).postTradeRequest(postTradeRequestInput, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
    ...
    > {
      const localVarAxiosArgs = await TradeApiAxiosParamCreator(
        configuration
      ).txTradeRequestGet(tradeId, from, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
 ...
 * @export
 */
export const TradeApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  return {
    ...
    deleteTrade(id: number, options?: any): AxiosPromise<Trade> {
      return TradeApiFp(configuration)
        .deleteTrade(id, options)
        .then(request => request(axios, basePath));
    },
    /**
...
export class TradeApi extends BaseAPI {
  ...
  public deleteTrade(id: number, options?: any) {
    return TradeApiFp(this.configuration)
      .deleteTrade(id, options)
      .then(request => request(this.axios, this.basePath));
  }
...
export const TxApiFp = function (configuration?: Configuration) {
  return {
    ...
    async txDividendGet(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<CrossTx>
    > {
      const localVarAxiosArgs = await TxApiAxiosParamCreator(
        configuration
      ).txDividendGet(estateId, perShare, options);
      return (
        axios: AxiosInstance = globalAxios,
 ...
 * @export
 */
export const TxApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
...
export class TxApi extends BaseAPI {
   ...
   */
  public txDividendGet(estateId: string, perShare: number, options?: any) {
    return TxApiFp(this.configuration)
      .txDividendGet(estateId, perShare, options)
      .then(request => request(this.axios, this.basePath));
  }
